...
public class ParamedoEntity extends MonsterEntity {
    private int attackTimer;


    public ParamedoEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static boolean canSpawn(EntityType<ParamedoEntity> type, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return (pos.getY() > 50);
    }
