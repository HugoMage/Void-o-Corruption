...
public class ParamedyEntity extends MonsterEntity {
    private int attackTimer;


    public ParamedyEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new PanicGoal(this, 1.3D));
    }
    ...
    public static boolean canSpawn(EntityType<ParamedyEntity> type, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return (pos.getY() > 50);
    }
