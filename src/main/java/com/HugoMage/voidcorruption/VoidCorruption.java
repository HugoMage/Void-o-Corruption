package com.HugoMage.voidcorruption;
...
import com.HugoMage.voidcorruption.world.gen.ModEntitySpawning;
...
@Mod("voidcorruption")
public class VoidCorruption
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "voidcorruption";
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        DeferredWorkQueue.runLater(() -> {
            GlobalEntityTypeAttributes.put(ModEntityTypes.VOIDAPE.get(), VoidApeEntity.setCustomAttributes().create());
            GlobalEntityTypeAttributes.put(ModEntityTypes.HUNGER.get(), HungerEntity.setCustomAttributes().create());
            GlobalEntityTypeAttributes.put(ModEntityTypes.PARAMEDO.get(), ParamedoEntity.setCustomAttributes().create());
            GlobalEntityTypeAttributes.put(ModEntityTypes.PARAMEDY.get(), ParamedyEntity.setCustomAttributes().create());
